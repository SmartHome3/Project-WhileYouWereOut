// ======================================================================
// AnalogCoProcessor_Design.v generated from TopDesign.cysch
// 12/23/2016 at 17:50
...
module Scan_ADC_v1_20_0 (
	...
	cy_connect_v1_0 vinMinusMux_2_connect(vinMinus[2], vinMinus_2);
    ...
    defparam cy_psoc4_sarmux_1.input_mode = "1111";
    defparam cy_psoc4_sarmux_1.muxin_width = 4;
	...
	cy_connect_v1_0 filterVinMux_3_0_connect(Net_1146, vinPlus[4]);
	...
	cy_connect_v1_0 filterVinMux_2_0_connect(Net_1142, vinPlus[4]);
	defparam filterVinMux_2_0_connect.sig_width = 1;

	// filterVinMux_1_0 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 filterVinMux_1_0_connect(Net_1136, vinPlus[4]);
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RefBuffer, CY_INSTANCE_SHORT_NAME=RefBuffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=RefBuffer, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PIRAmplifierStage1, CY_INSTANCE_SHORT_NAME=PIRAmplifierStage1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=PIRAmplifierStage1, )
...
// PGA_P4_v1_0(DeepSleepOperation=0, Gain=0, OutputBuffer=0, Power=3, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PGA_P4_v1_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PIRAmplifierStage2, CY_INSTANCE_SHORT_NAME=PIRAmplifierStage2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=PIRAmplifierStage2, )
module PGA_P4_v1_0_4 (
    Vin,
    Vref,
    Vout);
    inout       Vin;
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=Opamp_1, )
...
module top ;
    ...
    cy_annotation_universal_v1_0 R58 (
        .connect({
            Net_1715,
            Net_1505
        })
    );
    defparam R58.comp_name = "Resistor_v1_0";
    defparam R58.port_names = "T1, T2";
    defparam R58.width = 2;

    cy_annotation_universal_v1_0 C52 (
        .connect({
            Net_1484,
            Net_1715
        })
    );
    defparam C52.comp_name = "Capacitor_v1_0";
    defparam C52.port_names = "T1, T2";
    defparam C52.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("c0b33903-9af8-4ba3-9609-3e68669da53a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    OpAmp_P4_v1_20_3 PIRAmplifierStage1 (
        .Vplus(Net_1425),
        .Vout(Net_1515),
        .Vminus(Net_1504));
    ...
    cy_annotation_universal_v1_0 R56 (
        .connect({
            Net_1524,
            Net_1505
        })
    );
    defparam R56.comp_name = "Resistor_v1_0";
    defparam R56.port_names = "T1, T2";
    defparam R56.width = 2;

    cy_annotation_universal_v1_0 C48 (
        .connect({
            Net_1407,
            Net_1524
        })
    );
    defparam C48.comp_name = "Capacitor_v1_0";
    defparam C48.port_names = "T1, T2";
    defparam C48.width = 2;

    cy_annotation_universal_v1_0 R55 (
        .connect({
            Net_1407,
            Net_1484
        })
    );
    defparam R55.comp_name = "Resistor_v1_0";
    defparam R55.port_names = "T1, T2";
    defparam R55.width = 2;

    cy_annotation_universal_v1_0 C49 (
        .connect({
            Net_1407,
            Net_1484
        })
    );
    defparam C49.comp_name = "Capacitor_v1_0";
    defparam C49.port_names = "T1, T2";
    defparam C49.width = 2;
    ...
    cy_annotation_universal_v1_0 R119 (
        .connect({
            Net_1505,
            Net_1543
        })
    );
    defparam R119.comp_name = "Resistor_v1_0";
    defparam R119.port_names = "T1, T2";
    defparam R119.width = 2;

    cy_annotation_universal_v1_0 R118 (
        .connect({
            Net_1543,
            Net_1516
        })
    );
    defparam R118.comp_name = "Resistor_v1_0";
    defparam R118.port_names = "T1, T2";
    defparam R118.width = 2;

	wire [0:0] tmpOE__Pin_AmpOut_net;
	wire [0:0] tmpFB_0__Pin_AmpOut_net;
	wire [0:0] tmpIO_0__Pin_AmpOut_net;
	wire [0:0] tmpINTERRUPT_0__Pin_AmpOut_net;
	electrical [0:0] tmpSIOVREF__Pin_AmpOut_net;

	cy_psoc3_pins_v1_10
		#(.id("e38e0d69-ea90-4a6e-abea-2fd589043ee4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_AmpOut
		 (.oe(tmpOE__Pin_AmpOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_AmpOut_net[0:0]}),
		  .analog({Net_1515}),
		  .io({tmpIO_0__Pin_AmpOut_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_AmpOut_net),
		  .interrupt({tmpINTERRUPT_0__Pin_AmpOut_net[0:0]}),
		  .annotation({Net_1516}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_AmpOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 C81 (
        .connect({
            Net_1543,
            Net_1516
        })
    );
    defparam C81.comp_name = "Capacitor_v1_0";
    defparam C81.port_names = "T1, T2";
    defparam C81.width = 2;

    cy_annotation_universal_v1_0 C91 (
        .connect({
            Net_1516,
            Net_1861
        })
    );
    defparam C91.comp_name = "Capacitor_v1_0";
    defparam C91.port_names = "T1, T2";
    defparam C91.width = 2;

    cy_annotation_universal_v1_0 R147 (
        .connect({
            Net_1861,
            Net_1579
        })
    );
    defparam R147.comp_name = "Resistor_v1_0";
    defparam R147.port_names = "T1, T2";
    defparam R147.width = 2;

	wire [0:0] tmpOE__Pin_PGAIn_net;
	wire [0:0] tmpFB_0__Pin_PGAIn_net;
	wire [0:0] tmpIO_0__Pin_PGAIn_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PGAIn_net;
	electrical [0:0] tmpSIOVREF__Pin_PGAIn_net;

	cy_psoc3_pins_v1_10
		#(.id("3e78d78b-ca2a-4015-8e6d-5af852ace243"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PGAIn
		 (.oe(tmpOE__Pin_PGAIn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PGAIn_net[0:0]}),
		  .analog({Net_1782}),
		  .io({tmpIO_0__Pin_PGAIn_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PGAIn_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PGAIn_net[0:0]}),
		  .annotation({Net_1861}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_PGAIn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PGA_P4_v1_0_4 PIRAmplifierStage2 (
        .Vin(Net_1782),
        .Vref(Net_1590),
        .Vout(Net_2608));
	...
	cy_psoc3_pins_v1_10
		#(.id("e9f4d809-abd7-4c64-8727-0675f14e5b84"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 R51 (
        .connect({
            Net_2301,
            Net_2302
        })
    );
    defparam R51.comp_name = "Resistor_v1_0";
    defparam R51.port_names = "T1, T2";
    defparam R51.width = 2;
	...
	wire [0:0] tmpOE__Pin_Vhi_net;
	wire [0:0] tmpFB_0__Pin_Vhi_net;
	wire [0:0] tmpIO_0__Pin_Vhi_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Vhi_net;
	electrical [0:0] tmpSIOVREF__Pin_Vhi_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a21ae986-ea7a-42b9-8d2d-07025a19424e"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Vhi
		 (.oe(tmpOE__Pin_Vhi_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Vhi_net[0:0]}),
		  .analog({Net_2722}),
		  .io({tmpIO_0__Pin_Vhi_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Vhi_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Vhi_net[0:0]}),
		  .annotation({Net_2391}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Vhi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Vlow_net;
	wire [0:0] tmpFB_0__Pin_Vlow_net;
	wire [0:0] tmpIO_0__Pin_Vlow_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Vlow_net;
	electrical [0:0] tmpSIOVREF__Pin_Vlow_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("75a84975-39fc-4fd2-92c2-f5c652152bde"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Vlow
		 (.oe(tmpOE__Pin_Vlow_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Vlow_net[0:0]}),
		  .analog({Net_2901}),
		  .io({tmpIO_0__Pin_Vlow_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Vlow_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Vlow_net[0:0]}),
		  .annotation({Net_2808}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Vlow_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Vtherm_net;
	wire [0:0] tmpFB_0__Pin_Vtherm_net;
	wire [0:0] tmpIO_0__Pin_Vtherm_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Vtherm_net;
	electrical [0:0] tmpSIOVREF__Pin_Vtherm_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Vtherm
		 (.oe(tmpOE__Pin_Vtherm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Vtherm_net[0:0]}),
		  .analog({Net_2705}),
		  .io({tmpIO_0__Pin_Vtherm_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Vtherm_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Vtherm_net[0:0]}),
		  .annotation({Net_2807}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Vtherm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5ad269d1-fcfe-438b-9c78-5d3fe2bc8502"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
